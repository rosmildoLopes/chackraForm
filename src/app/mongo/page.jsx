...
const MongoForm = () => {
  ...
  return (
    <div className=" p-4 mx-auto flex flex-col items-center max-w-xl shadow-lg rounded-lg my-4 bg-white">
      <h1 className="font-bold text-3xl mb-2">Contactános </h1>
      ...
      <form
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            className="shadow-lg px-6 py-2 border border-slate-300 bg-blue-100 rounded-lg"
            {...register('fullname')}
          />
        </div>
        <div className="flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-2">
          ...
          <textarea
            ...
            className="shadow-lg px-6 py-2 resize-none border border-slate-300 bg-blue-100 rounded-lg h-32"
            {...register('message')}
          />
        </div>
